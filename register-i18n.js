...
REGISTER.it = {
    ...
    registerBtnPaid: '📲 Registrati e vai su Telegram →',
    s1SubPaid: 'Registrati per attivare il piano selezionato',
...
REGISTER.en = {
    ...
    registerBtnPaid: '📲 Sign up and open Telegram →',
    s1SubPaid: 'Sign up to activate your selected plan',
...
REGISTER.ru = {
    ...
    registerBtnPaid: '📲 Зарегистрироваться и открыть Telegram →',
    s1SubPaid: 'Зарегистрируйтесь для активации выбранного плана',
...
REGISTER.cn = {
    ...
    clp3: '付款后立即激活许可证',
    registerBtn: '🎯 开始试用 →',
    registerBtnPaid: '📲 注册并跳转至 Telegram →',
    s1SubPaid: '注册以激活所选方案',
    registering: '⏳ 注册中...',
